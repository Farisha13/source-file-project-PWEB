...
<head>
    ...
    <style>
        .mx-auto {
            width: 800px;
            margin-top: 20px; /* Tambahan margin-top untuk memberi ruang antara judul dan tabel */
        }
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="jurusan" id="jurusan">
                                ...
                                <option value="Mesin" <?php if ($jurusan == "Mesin") echo "selected" ?>>Mesin</option>
                                <option value="Elektro" <?php if ($jurusan == "Teknik Elektro") echo "selected" ?>>Elektro</option>
                                <option value="Sipil" <?php if ($jurusan == "Sipil") echo "selected" ?>>Sipil</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
